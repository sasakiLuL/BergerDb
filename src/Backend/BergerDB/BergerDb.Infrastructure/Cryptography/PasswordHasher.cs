...
public class PasswordHasher : IPasswordHashChecker, IPasswordHasher, IDisposable
{
    ...
    public bool HashesMatch(string passwordHash, string providedPassword)
    {
        ...
        char[] t = passwordHash.ToCharArray();

        byte[] decodedHashedPassword = Convert.FromBase64CharArray(t, 0, t.Length);
