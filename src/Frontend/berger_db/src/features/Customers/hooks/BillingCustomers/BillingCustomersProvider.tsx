...
export interface BillingCustomersProviderProps {
  children: ReactNode;
}
...
export const useBillingCustomers = () => useContext(CustomersContext);

export default function BillingCustomersProvider({
  children,
}: BillingCustomersProviderProps) {
